...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 114
    invoke-virtual/range {v3 .. v8}, Lmiuix/animation/internal/RunnerHandler;->runAnim(JJZ)V
    ...
    invoke-virtual {p0, v2, v0, v3}, Lmiuix/animation/internal/RunnerHandler;->addToMap(Lmiuix/animation/IAnimTarget;Lmiuix/animation/utils/LinkNode;Ljava/util/Map;)V
...
.method public final runAnim(JJZ)V
    ...
    invoke-virtual {p0, v2, p1, v0}, Lmiuix/animation/internal/RunnerHandler;->addAnimTask(Ljava/util/List;II)V
...
.method public final updateAnim()V
    ...
    invoke-virtual {p0, v3, v5}, Lmiuix/animation/internal/RunnerHandler;->updateTarget(Lmiuix/animation/IAnimTarget;Ljava/util/List;)Z

    move-result v5

    if-nez v5, :cond_1

    invoke-virtual {p0, v3}, Lmiuix/animation/internal/RunnerHandler;->setupWaitTrans(Lmiuix/animation/IAnimTarget;)Z
...
.method public final updateTarget(Lmiuix/animation/IAnimTarget;Ljava/util/List;)Z
    ...
    const-string/jumbo v11, "opInfo.time = "
    ...
    const-string/jumbo v6, "stats.isRunning = "
