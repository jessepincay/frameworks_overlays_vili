...
.field public final mMediaActionReceiver:Landroid/content/BroadcastReceiver;
...
.field public final mPlaybackChangedListener:Landroid/media/session/MediaController$Callback;
...
.method public static synthetic $r8$lambda$Ig33Ic_K41wQXjQN8GDv5IoJfvM(Landroid/media/session/MediaSession$Token;Lcom/android/wm/shell/pip/PipMediaController$TokenListener;)V
    .locals 0
...
.method public static bridge synthetic -$$Nest$fgetmMediaController(Lcom/android/wm/shell/pip/PipMediaController;)Landroid/media/session/MediaController;
    .locals 0
...
.method public static bridge synthetic -$$Nest$mnotifyActionsChanged(Lcom/android/wm/shell/pip/PipMediaController;)V
    .locals 0

    invoke-virtual {p0}, Lcom/android/wm/shell/pip/PipMediaController;->notifyActionsChanged()V

    return-void
.end method

.method public static bridge synthetic -$$Nest$mnotifyMetadataChanged(Lcom/android/wm/shell/pip/PipMediaController;Landroid/media/MediaMetadata;)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/android/wm/shell/pip/PipMediaController;->notifyMetadataChanged(Landroid/media/MediaMetadata;)V
...
.method public static synthetic lambda$notifyActionsChanged$0(Ljava/util/List;Lcom/android/wm/shell/pip/PipMediaController$ActionListener;)V
    .locals 0
...
.method public static synthetic lambda$notifyMetadataChanged$1(Landroid/media/MediaMetadata;Lcom/android/wm/shell/pip/PipMediaController$MetadataListener;)V
    .locals 0
...
.method public static synthetic lambda$notifyTokenChanged$2(Landroid/media/session/MediaSession$Token;Lcom/android/wm/shell/pip/PipMediaController$TokenListener;)V
    .locals 0
...
.method public final getMediaMetadata()Landroid/media/MediaMetadata;
    .locals 0
...
.method public final notifyActionsChanged()V
    .locals 2
...
.method public final notifyMetadataChanged(Landroid/media/MediaMetadata;)V
    .locals 1
...
.method public final notifyTokenChanged(Landroid/media/session/MediaSession$Token;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lcom/android/wm/shell/pip/PipMediaController$$ExternalSyntheticLambda3;-><init>(Landroid/media/session/MediaSession$Token;)V
...
.method public final setActiveMediaController(Landroid/media/session/MediaController;)V
    ...
    .line 333
    invoke-virtual {p0}, Lcom/android/wm/shell/pip/PipMediaController;->getMediaMetadata()Landroid/media/MediaMetadata;
    ...
    .line 334
    invoke-virtual {p0}, Lcom/android/wm/shell/pip/PipMediaController;->getToken()Landroid/media/session/MediaSession$Token;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/android/wm/shell/pip/PipMediaController;->notifyTokenChanged(Landroid/media/session/MediaSession$Token;)V
