...
.method public calculateBoundsAndAngle(Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/Point;Landroid/graphics/Point;Landroid/graphics/Rect;Landroid/graphics/Rect;)F
    ...
    .line 48
    invoke-virtual {p0, p7, p5}, Lcom/android/wm/shell/pip/phone/PipPinchResizingAlgorithm;->getMinScale(Landroid/graphics/Rect;Landroid/graphics/Point;)F

    move-result p5

    .line 49
    invoke-virtual {p0, p7, p6}, Lcom/android/wm/shell/pip/phone/PipPinchResizingAlgorithm;->getMaxScale(Landroid/graphics/Rect;Landroid/graphics/Point;)F
    ...
    .line 57
    invoke-virtual {p0, p8, p5}, Lcom/android/wm/shell/pip/phone/PipPinchResizingAlgorithm;->scaleRectAboutCenter(Landroid/graphics/Rect;F)V

    .line 60
    iget-object p5, p0, Lcom/android/wm/shell/pip/phone/PipPinchResizingAlgorithm;->mTmpDownCentroid:Landroid/graphics/PointF;

    invoke-virtual {p0, p1, p2, p5}, Lcom/android/wm/shell/pip/phone/PipPinchResizingAlgorithm;->getCentroid(Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)V

    .line 61
    iget-object p5, p0, Lcom/android/wm/shell/pip/phone/PipPinchResizingAlgorithm;->mTmpLastCentroid:Landroid/graphics/PointF;

    invoke-virtual {p0, p3, p4, p5}, Lcom/android/wm/shell/pip/phone/PipPinchResizingAlgorithm;->getCentroid(Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/wm/shell/pip/phone/PipPinchResizingAlgorithm;->cross(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
    ...
    .line 71
    invoke-virtual {p0, p3, p4}, Lcom/android/wm/shell/pip/phone/PipPinchResizingAlgorithm;->dot(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
    ...
    invoke-virtual {p0, p1}, Lcom/android/wm/shell/pip/phone/PipPinchResizingAlgorithm;->constrainRotationAngle(F)F
...
.method public final constrainRotationAngle(F)F
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lcom/android/wm/shell/pip/phone/PipPinchResizingAlgorithm;->dampedRotate(F)F
...
.method public final cross(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
    .locals 1
...
.method public final dampedRotate(F)F
    .locals 2
    ...
    invoke-virtual {p0, p1}, Lcom/android/wm/shell/pip/phone/PipPinchResizingAlgorithm;->overRotateInfluenceCurve(F)F
...
.method public final dot(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
    .locals 1
...
.method public final getCentroid(Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)V
    .locals 1
...
.method public final getMaxScale(Landroid/graphics/Rect;Landroid/graphics/Point;)F
    .locals 1
...
.method public final getMinScale(Landroid/graphics/Rect;Landroid/graphics/Point;)F
    .locals 1
...
.method public final overRotateInfluenceCurve(F)F
    .locals 1
