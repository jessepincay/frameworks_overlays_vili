...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer$LayoutParams;
    }
.end annotation
...
.method public bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 13
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer;->generateDefaultLayoutParams()Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer$LayoutParams;
...
.method public generateDefaultLayoutParams()Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer$LayoutParams;
    .locals 1
    ...
    invoke-direct {p0, v0, v0}, Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer$LayoutParams;-><init>(II)V
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 13
    invoke-virtual {p0, p1}, Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer;->generateLayoutParams(Landroid/util/AttributeSet;)Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer$LayoutParams;
...
.method public bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 13
    invoke-virtual {p0, p1}, Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer$LayoutParams;
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer$LayoutParams;
    .locals 1
...
.method public generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer$LayoutParams;
    .locals 0
...
.method public onLayout(ZIIII)V
    ...
    :goto_0
    invoke-virtual {p0, p5, v1}, Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer;->getChildTop(II)I
    ...
    .line 93
    :goto_1
    invoke-virtual {p0, p5, v1}, Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer;->getChildBottom(II)I
    ...
    .line 102
    iget-object p2, p0, Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer;->mStatusIcon:Landroid/view/View;

    invoke-virtual {p0, p5, p1}, Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer;->getChildTop(II)I

    move-result p3

    .line 103
    invoke-virtual {p0, p5, p1}, Lcom/android/systemui/statusbar/views/MiuiStatusBatteryContainer;->getChildBottom(II)I
