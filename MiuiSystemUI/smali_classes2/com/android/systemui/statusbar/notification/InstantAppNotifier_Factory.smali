...
.method public static create(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)Lcom/android/systemui/statusbar/notification/InstantAppNotifier_Factory;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1, p2}, Lcom/android/systemui/statusbar/notification/InstantAppNotifier_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    return-object v0
.end method

.method public static newInstance(Landroid/content/Context;Lcom/android/systemui/statusbar/CommandQueue;Ljava/util/concurrent/Executor;)Lcom/android/systemui/statusbar/notification/InstantAppNotifier;
    .locals 1

    .line 46
    new-instance v0, Lcom/android/systemui/statusbar/notification/InstantAppNotifier;

    invoke-direct {v0, p0, p1, p2}, Lcom/android/systemui/statusbar/notification/InstantAppNotifier;-><init>(Landroid/content/Context;Lcom/android/systemui/statusbar/CommandQueue;Ljava/util/concurrent/Executor;)V
...
.method public get()Lcom/android/systemui/statusbar/notification/InstantAppNotifier;
    ...
    invoke-static {v0, v1, p0}, Lcom/android/systemui/statusbar/notification/InstantAppNotifier_Factory;->newInstance(Landroid/content/Context;Lcom/android/systemui/statusbar/CommandQueue;Ljava/util/concurrent/Executor;)Lcom/android/systemui/statusbar/notification/InstantAppNotifier;
