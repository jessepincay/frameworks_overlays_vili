...
.method public captureHeaps(Ljava/util/List;)Lcom/android/systemui/util/leak/DumpTruck;
    ...
    iget-object v1, p0, Lcom/android/systemui/util/leak/DumpTruck;->context:Landroid/content/Context;
    ...
    .line 72
    iput-object v1, p0, Lcom/android/systemui/util/leak/DumpTruck;->hprofUri:Landroid/net/Uri;

    .line 74
    iget-object v1, p0, Lcom/android/systemui/util/leak/DumpTruck;->body:Ljava/lang/StringBuilder;
    ...
    .line 83
    iget-object v8, p0, Lcom/android/systemui/util/leak/DumpTruck;->mGarbageMonitor:Lcom/android/systemui/util/leak/GarbageMonitor;

    invoke-virtual {v8, v4}, Lcom/android/systemui/util/leak/GarbageMonitor;->getMemInfo(I)Lcom/android/systemui/util/leak/GarbageMonitor$ProcessMemInfo;
    ...
    .line 87
    invoke-virtual {v8}, Lcom/android/systemui/util/leak/GarbageMonitor$ProcessMemInfo;->getUptime()J
    ...
    iget-wide v10, v8, Lcom/android/systemui/util/leak/GarbageMonitor$ProcessMemInfo;->currentRss:J

    .line 89
    invoke-virtual {v9, v10, v11}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    .line 90
    iget-wide v8, v8, Lcom/android/systemui/util/leak/GarbageMonitor$ProcessMemInfo;->currentRss:J

    iput-wide v8, p0, Lcom/android/systemui/util/leak/DumpTruck;->rss:J
    ...
    const-string v9, "Dumping memory info for process "
    ...
    .line 99
    iget-object v4, p0, Lcom/android/systemui/util/leak/DumpTruck;->body:Ljava/lang/StringBuilder;

    const-string v5, " (hprof attached)"
    ...
    const-string v5, "error dumping memory:"
    ...
    .line 112
    invoke-static {p1, v1}, Lcom/android/systemui/util/leak/DumpTruck;->zipUp(Ljava/lang/String;Ljava/util/ArrayList;)Z
