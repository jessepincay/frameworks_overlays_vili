...
.method public static bridge synthetic -$$Nest$fgetmContext(Lcom/android/settingslib/wifi/WifiTracker;)Landroid/content/Context;
    .locals 0
...
.method public static bridge synthetic -$$Nest$fgetmRegistered(Lcom/android/settingslib/wifi/WifiTracker;)Z
    .locals 0
...
.method public static bridge synthetic -$$Nest$fputmLastScanSucceeded(Lcom/android/settingslib/wifi/WifiTracker;Z)V
    .locals 0
...
.method public static bridge synthetic -$$Nest$fputmStaleScanResults(Lcom/android/settingslib/wifi/WifiTracker;Z)V
    .locals 0
...
.method public static bridge synthetic -$$Nest$mfetchScansAndConfigsAndUpdateAccessPoints(Lcom/android/settingslib/wifi/WifiTracker;)V
    .locals 0
...
.method public static bridge synthetic -$$Nest$mupdateNetworkInfo(Lcom/android/settingslib/wifi/WifiTracker;Landroid/net/NetworkInfo;)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/android/settingslib/wifi/WifiTracker;->updateNetworkInfo(Landroid/net/NetworkInfo;)V

    return-void
.end method

.method public static bridge synthetic -$$Nest$mupdateNetworkScores(Lcom/android/settingslib/wifi/WifiTracker;)V
    .locals 0

    invoke-virtual {p0}, Lcom/android/settingslib/wifi/WifiTracker;->updateNetworkScores()V

    return-void
.end method

.method public static bridge synthetic -$$Nest$mupdateWifiState(Lcom/android/settingslib/wifi/WifiTracker;I)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/android/settingslib/wifi/WifiTracker;->updateWifiState(I)V

    return-void
.end method

.method public static bridge synthetic -$$Nest$smisVerboseLoggingEnabled()Z
    .locals 1
...
.method public static isSaeOrOwe(Landroid/net/wifi/WifiConfiguration;)Z
    .locals 1
...
.method public static synthetic lambda$updateAccessPoints$0(Lcom/android/settingslib/wifi/AccessPoint;Landroid/net/wifi/WifiConfiguration;)Z
    .locals 0
...
.method public static synthetic lambda$updateAccessPoints$1(Landroid/net/wifi/WifiConfiguration;)Z
    .locals 0
...
.method public final clearAccessPointsAndConditionallyUpdate()V
    ...
    .line 845
    invoke-virtual {p0}, Lcom/android/settingslib/wifi/WifiTracker;->conditionallyNotifyListeners()V
...
.method public final conditionallyNotifyListeners()V
    .locals 1
...
.method public final fetchScansAndConfigsAndUpdateAccessPoints()V
    ...
    .line 548
    invoke-virtual {p0, v0}, Lcom/android/settingslib/wifi/WifiTracker;->filterScanResultsByCapabilities(Ljava/util/List;)Ljava/util/List;
    ...
    .line 555
    invoke-virtual {p0, v0, v1}, Lcom/android/settingslib/wifi/WifiTracker;->updateAccessPoints(Ljava/util/List;Ljava/util/List;)V

    return-void
.end method

.method public final filterScanResultsByCapabilities(Ljava/util/List;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final getCachedByKey(Ljava/util/List;Ljava/lang/String;)Lcom/android/settingslib/wifi/AccessPoint;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final getCachedOrCreate(Ljava/util/List;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;
    ...
    .line 731
    invoke-virtual {p0, p2, v0}, Lcom/android/settingslib/wifi/WifiTracker;->getCachedByKey(Ljava/util/List;Ljava/lang/String;)Lcom/android/settingslib/wifi/AccessPoint;
...
.method public final getCachedOrCreateOsu(Landroid/net/wifi/hotspot2/OsuProvider;Ljava/util/List;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p3, v0}, Lcom/android/settingslib/wifi/WifiTracker;->getCachedByKey(Ljava/util/List;Ljava/lang/String;)Lcom/android/settingslib/wifi/AccessPoint;
...
.method public final getCachedOrCreatePasspoint(Landroid/net/wifi/WifiConfiguration;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p4, v0}, Lcom/android/settingslib/wifi/WifiTracker;->getCachedByKey(Ljava/util/List;Ljava/lang/String;)Lcom/android/settingslib/wifi/AccessPoint;
...
.method public onStart()V
    ...
    .line 330
    invoke-virtual {p0}, Lcom/android/settingslib/wifi/WifiTracker;->registerScoreCache()V
...
.method public onStop()V
    ...
    .line 407
    :cond_0
    invoke-virtual {p0}, Lcom/android/settingslib/wifi/WifiTracker;->unregisterScoreCache()V
...
.method public final registerScoreCache()V
    .locals 3
...
.method public final unregisterScoreCache()V
    .locals 3
...
.method public final updateAccessPoints(Ljava/util/List;Ljava/util/List;)V
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0, p2}, Lcom/android/settingslib/wifi/WifiTracker;->getWifiConfigurationForNetworkId(ILjava/util/List;)Landroid/net/wifi/WifiConfiguration;
    ...
    .line 571
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/android/settingslib/wifi/WifiTracker;->updateScanResultCache(Ljava/util/List;)Landroid/util/ArrayMap;
    ...
    invoke-virtual {p0, v6, v3}, Lcom/android/settingslib/wifi/WifiTracker;->getCachedOrCreate(Ljava/util/List;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;
    ...
    .line 642
    :cond_8
    invoke-virtual {p0, v5}, Lcom/android/settingslib/wifi/WifiTracker;->requestScoresForNetworkKeys(Ljava/util/Collection;)V
...
.method public final updateNetworkScores()V
    .locals 8
...
.method public updateOsuAccessPoints(Ljava/util/Map;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {p0, v3, v4, p2}, Lcom/android/settingslib/wifi/WifiTracker;->getCachedOrCreateOsu(Landroid/net/wifi/hotspot2/OsuProvider;Ljava/util/List;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;
...
.method public updatePasspointAccessPoints(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 700
    invoke-virtual {p0, v3, v4, v2, p2}, Lcom/android/settingslib/wifi/WifiTracker;->getCachedOrCreatePasspoint(Landroid/net/wifi/WifiConfiguration;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lcom/android/settingslib/wifi/AccessPoint;
...
.method public final updateScanResultCache(Ljava/util/List;)Landroid/util/ArrayMap;
    ...
    .line 480
    :cond_2
    invoke-virtual {p0}, Lcom/android/settingslib/wifi/WifiTracker;->evictOldScans()V
...
.method public final updateWifiState(I)V
    .locals 3
