...
.field public final mRemoteSessionCallback:Landroid/media/session/MediaSessionManager$RemoteSessionCallback;

.field public final mSessionsListener:Landroid/media/session/MediaSessionManager$OnActiveSessionsChangedListener;


# direct methods
.method public static bridge synthetic -$$Nest$fgetmCallbacks(Lcom/android/settingslib/volume/MediaSessions;)Lcom/android/settingslib/volume/MediaSessions$Callbacks;
    .locals 0
...
.method public static bridge synthetic -$$Nest$fgetmHandler(Lcom/android/settingslib/volume/MediaSessions;)Lcom/android/settingslib/volume/MediaSessions$H;
    .locals 0
...
.method public static bridge synthetic -$$Nest$fgetmMgr(Lcom/android/settingslib/volume/MediaSessions;)Landroid/media/session/MediaSessionManager;
    .locals 0
...
.method public static bridge synthetic -$$Nest$monRemoteVolumeChangedH(Lcom/android/settingslib/volume/MediaSessions;Landroid/media/session/MediaSession$Token;I)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lcom/android/settingslib/volume/MediaSessions;->onRemoteVolumeChangedH(Landroid/media/session/MediaSession$Token;I)V

    return-void
.end method

.method public static bridge synthetic -$$Nest$monUpdateRemoteSessionListH(Lcom/android/settingslib/volume/MediaSessions;Landroid/media/session/MediaSession$Token;)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/android/settingslib/volume/MediaSessions;->onUpdateRemoteSessionListH(Landroid/media/session/MediaSession$Token;)V

    return-void
.end method

.method public static bridge synthetic -$$Nest$mupdateRemoteH(Lcom/android/settingslib/volume/MediaSessions;Landroid/media/session/MediaSession$Token;Ljava/lang/String;Landroid/media/session/MediaController$PlaybackInfo;)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lcom/android/settingslib/volume/MediaSessions;->updateRemoteH(Landroid/media/session/MediaSession$Token;Ljava/lang/String;Landroid/media/session/MediaController$PlaybackInfo;)V
...
.method public static bridge synthetic -$$Nest$smisRemote(Landroid/media/session/MediaController$PlaybackInfo;)Z
    .locals 0
...
# virtual methods
.method public getControllerName(Landroid/media/session/MediaController;)Ljava/lang/String;
    .locals 1
...
.method public onActiveSessionsUpdatedH(Ljava/util/List;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v2, v4, v3}, Lcom/android/settingslib/volume/MediaSessions;->updateRemoteH(Landroid/media/session/MediaSession$Token;Ljava/lang/String;Landroid/media/session/MediaController$PlaybackInfo;)V
...
.method public final onRemoteVolumeChangedH(Landroid/media/session/MediaSession$Token;I)V
    .locals 3
...
.method public final onUpdateRemoteSessionListH(Landroid/media/session/MediaSession$Token;)V
    .locals 3
...
.method public postUpdateSessions()V
    .locals 1
