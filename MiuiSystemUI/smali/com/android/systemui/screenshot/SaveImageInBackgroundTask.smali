.class public Lcom/android/systemui/screenshot/SaveImageInBackgroundTask;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/screenshot/ImageExporter;Lcom/android/systemui/screenshot/ScreenshotSmartActions;Lcom/android/systemui/screenshot/ScreenshotController$SaveImageInBackgroundData;Ljava/util/function/Supplier;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static addIntentExtras(Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Z)V
    .locals 1
...
# virtual methods
.method public final buildSmartActions(Ljava/util/List;Landroid/content/Context;)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public createEditAction(Landroid/content/Context;Landroid/content/res/Resources;Landroid/net/Uri;)Ljava/util/function/Supplier;
    ...
    invoke-direct {v0, p0, p1, p3, p2}, Lcom/android/systemui/screenshot/SaveImageInBackgroundTask$$ExternalSyntheticLambda0;-><init>(Lcom/android/systemui/screenshot/SaveImageInBackgroundTask;Landroid/content/Context;Landroid/net/Uri;Landroid/content/res/Resources;)V
...
.method public varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Void;
    ...
    invoke-virtual {v0, v3}, Lcom/android/systemui/screenshot/SaveImageInBackgroundTask;->getUserHandleOfForegroundApplication(Landroid/content/Context;)Landroid/os/UserHandle;
    ...
    .line 159
    invoke-virtual {v0, v4, v5}, Lcom/android/systemui/screenshot/SaveImageInBackgroundTask;->buildSmartActions(Ljava/util/List;Landroid/content/Context;)Ljava/util/List;
...
.method public final getUserHandleOfForegroundApplication(Landroid/content/Context;)Landroid/os/UserHandle;
    .locals 1
...
.method public setActionsReadyListener(Lcom/android/systemui/screenshot/ScreenshotController$ActionsReadyListener;)V
    .locals 0
