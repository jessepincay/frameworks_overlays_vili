.class public Lcom/android/systemui/classifier/ZigZagClassifier;
...
.method public calculateFalsingResult(IDD)Lcom/android/systemui/classifier/FalsingClassifier$Result;
    ...
    .line 114
    invoke-virtual {p0}, Lcom/android/systemui/classifier/ZigZagClassifier;->rotateHorizontal()Ljava/util/List;
    ...
    .line 116
    :cond_2
    invoke-virtual {p0}, Lcom/android/systemui/classifier/ZigZagClassifier;->rotateVertical()Ljava/util/List;
    ...
    :cond_7
    :goto_3
    invoke-virtual {p0}, Lcom/android/systemui/classifier/ZigZagClassifier;->getReason()Ljava/lang/String;
...
.method public final rotateHorizontal()Ljava/util/List;
    .locals 4
    ...
    invoke-virtual {p0, v2, v0, v1}, Lcom/android/systemui/classifier/ZigZagClassifier;->rotateMotionEvents(Ljava/util/List;D)Ljava/util/List;
...
.method public final rotateMotionEvents(Ljava/util/List;D)Ljava/util/List;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final rotateVertical()Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/android/systemui/classifier/ZigZagClassifier;->rotateMotionEvents(Ljava/util/List;D)Ljava/util/List;
