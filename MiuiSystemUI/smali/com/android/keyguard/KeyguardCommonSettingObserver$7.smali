...
.method public constructor <init>(ILcom/android/keyguard/KeyguardCommonSettingObserver;Lcom/android/systemui/broadcast/BroadcastDispatcher;Lcom/android/systemui/util/settings/SecureSettings;Landroid/os/Handler;)V
    ...
    iput p1, p0, Lcom/android/keyguard/KeyguardCommonSettingObserver$7;->$userId:I
    ...
    const-string v4, "face_unlock_by_notification_screen_on"
...
.method public handleValueChanged(IZ)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lcom/android/keyguard/KeyguardCommonSettingObserver;->setFaceUnlockStartByNotificationScreenOn(Z)V
